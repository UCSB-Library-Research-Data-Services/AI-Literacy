...
| Institution | Auburn | Baylor | Chapman | U of Arkansas | UC Davis | UC Irvine | UC Merced | UCSB | UCSD | USC | William & Mary |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| **U of Arkansas** | 0.835 | **0.942** | 0.841 | **1.000** | 0.873 | 0.810 | 0.842 | 0.856 | 0.844 | 0.838 | 0.849 |
| **UC Davis** | 0.941 | 0.875 | 0.938 | 0.873 | **1.000** | 0.885 | **0.964** | **0.961** | **0.961** | 0.939 | 0.940 |
| **UC Irvine** | 0.852 | 0.812 | 0.868 | 0.810 | 0.885 | **1.000** | 0.874 | 0.878 | 0.862 | 0.860 | 0.864 |
| **UC Merced** | 0.940 | 0.848 | 0.943 | 0.842 | **0.964** | 0.874 | **1.000** | **0.952** | 0.938 | 0.936 | 0.934 |
...
%%{init: {'flowchart': {'curve': 'basis', 'htmlLabels': false}, 'themeVariables': {'fontSize': '14px'}}}%%
flowchart LR
    ...
    classDef nodeRoot fill:#1e293b,stroke:#0f172a,stroke-width:2px,color:#ffffff;
    classDef ucHeader fill:#1d4ed8,stroke:#1e40af,stroke-width:2px,color:#ffffff;
    classDef ucNode fill:#eff6ff,stroke:#3b82f6,stroke-width:1.5px,color:#1e40af;
    ...
    classDef demystHeader fill:#d97706,stroke:#b45309,stroke-width:2px,color:#ffffff;
    classDef demystNode fill:#fffbeb,stroke:#f59e0b,stroke-width:1.5px,color:#92400e;

    class ALL nodeRoot;
    class UC ucHeader;
    class U1,U2,U3,U4,U5 ucNode;
    class TD toolHeader;
    class T1,T2 toolNode;
    class CO critHeader;
    class C1 critNode;
    class DH demystHeader;
    class D1,D2,D3 demystNode;
```
